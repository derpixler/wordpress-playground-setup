...
cp assets/data/databases/0809017_usr_p366984_1_preview.sql ${dumpfolder}0809017_usr_p366984_1_preview.sql
printf "  - Copy ${GREEN}0809017_usr_p366984_1_preview.sql -> ${dumpfolder}0809017_usr_p366984_1_preview.sql${NC}\n    Files copied\n\n"
